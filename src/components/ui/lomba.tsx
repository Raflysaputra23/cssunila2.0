      ...
      <section className="mt-4 grid grid-cols-2 gap-4">
        {components.map((item: ComponentLomba) => (
          <Link href={item.href} key={item.title} className="col-span-2 lg:col-span-1">
            <Card className="bg-slate-800 shadow text-slate-200 transition hover:bg-slate-900 hover:scale-105 cursor-pointer">
                <CardHeader>
                ...
                <CardFooter>
                    {/* <p>Card Footer</p> */}
                    <Button className="hover:bg-slate-800 hover:border-slate-700 bg-slate-700 cursor-pointer">
