const About = () => {
  return (
    <section id="about" className="max-w-[95%] lg:max-w-[85%] py-10 mx-auto">
      <h2 className="bg-slate-900 text-slate-200 py-2 px-3 rounded-md shadow inline-block">
        About
      </h2>
      <section className="p-4 shadow rounded-md bg-slate-900 mt-2">
        ...
        <section className="flex items-center gap-2 mt-2 flex-wrap">
            <p className="bg-slate-800 text-slate-200 py-2 px-3 rounded-md shadow border border-transparent inline-block text-sm hover:bg-slate-950 hover:border-slate-200  transition">Sertifikat</p>
            <p className="bg-slate-800 text-slate-200 py-2 px-3 rounded-md shadow border border-transparent inline-block text-sm hover:bg-slate-950 hover:border-slate-200 transition">Menambah pengalaman di CV</p>
            <p className="bg-slate-800 text-slate-200 py-2 px-3 rounded-md shadow border border-transparent inline-block text-sm hover:bg-slate-950 hover:border-slate-200 transition">Relasi & Skill</p>
            <p className="bg-slate-800 text-slate-200 py-2 px-3 rounded-md shadow border border-transparent inline-block text-sm hover:bg-slate-950 hover:border-slate-200 transition">Uang tunai  </p>
        </section>
      </section>
    </section>
  );
